...
import TimesTableGenerator from './components/TimesTableGenerator.vue'
...
/*     const dateDiv = document.createElement('div')
    ...
    const routes = [
        { path: '/', component: TimesTableGenerator }
    ]
    ...
    const app = createApp(TimesTableGenerator)
    app.use(router)
...
if (process.env.NODE_ENV === 'development') {
    const devRoot = document.querySelector('#_ttg-dev-root')
